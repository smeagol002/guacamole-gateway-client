...
import { GuacamoleRemoteDesktopComponent } from './remote-desktop/remote-desktop.component';
...
@NgModule({
  declarations: [
    GuacamoleRemoteDesktopComponent,
...
export class GuacamoleRemoteDesktopModule {}
