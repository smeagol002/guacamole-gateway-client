...
export interface vncGuacLiteOptions {
  type: 'vnc';
  settings: vnc_settings;
  maxInactivityTime?: number;
}

export interface rdpGuacLiteOptions {
  type: 'rdp';
  settings: rdp_settings;
  maxInactivityTime?: number;
}

export interface sshGuacLiteOptions {
  type: 'ssh';
  settings: ssh_settings;
  maxInactivityTime?: number;
}

export interface telnetGuacLiteOptions {
  type: 'telnet';
  settings: telnet_settings;
  maxInactivityTime?: number;
}

export interface kubernetesGuacLiteOptions {
  type: 'kubernetes';
  settings: kubernetes_settings;
  maxInactivityTime?: number;
}

export type guac_token_params = vncGuacLiteOptions | rdpGuacLiteOptions | sshGuacLiteOptions | telnetGuacLiteOptions | kubernetesGuacLiteOptions;
